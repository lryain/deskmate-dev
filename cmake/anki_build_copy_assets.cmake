...
if(DEPLOY_WITH_CMAKE)
    function(lrya_build_copy_assets)
        ...
        set(PLATFORM_SRCLIST_FILE "${cpassets_SRCLIST_DIR}/${cpassets_TARGET}_${LRYA_PLATFORM_NAME}.srcs.lst")
        set(PLATFORM_DSTLIST_FILE "${cpassets_SRCLIST_DIR}/${cpassets_TARGET}_${LRYA_PLATFORM_NAME}.dsts.lst")
    ...
    macro(lrya_build_prune_files)
        ...
        add_custom_command(
            ...
            COMMAND ${CMAKE_SOURCE_DIR}/project/deskmate/scripts/prune-dir.sh -c
    ...
    function(lrya_build_copy_assets)
        ...
        add_custom_command(
            ...
            PRE_BUILD
            COMMAND python3 ${CMAKE_SOURCE_DIR}/python/lrya_build_copy_assets.py
            --target ${cpassets_TARGET}
            --srclist_dir ${cpassets_SRCLIST_DIR}
            --output_dir ${cpassets_OUTPUT_DIR}
            --lrya_platform_name ${LRYA_PLATFORM_NAME}
