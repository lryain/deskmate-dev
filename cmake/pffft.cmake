...
if (MATEOS)
  set(LIBPFFFT_INCLUDE_PATH "${LRYA_THIRD_PARTY_DIR}/pffft/mateos/include")
  set(LIBPFFFT_LIB_PATH "${LRYA_THIRD_PARTY_DIR}/pffft/mateos/lib")
elseif (MACOSX)
  set(LIBPFFFT_INCLUDE_PATH "${LRYA_THIRD_PARTY_DIR}/pffft/mac/include")
  set(LIBPFFFT_LIB_PATH "${LRYA_THIRD_PARTY_DIR}/pffft/mac/lib")
endif()
...
foreach(LIB ${PFFFT_LIBS})
  ...
  lrya_build_target_license(${LIB} "FFTPACK5,${CMAKE_SOURCE_DIR}/licenses/pffft.license")
endforeach()
