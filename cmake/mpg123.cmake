...
if (MATEOS)
  set(LIBMPG123_INCLUDE_PATH "${LRYA_THIRD_PARTY_DIR}/mpg123/mateos/include")
  set(LIBMPG123_LIB_PATH "${LRYA_THIRD_PARTY_DIR}/mpg123/mateos/lib")
  set(LIBMPG123_EXT "so.0")
elseif (MACOSX)
  set(LIBMPG123_INCLUDE_PATH "${LRYA_THIRD_PARTY_DIR}/mpg123/mac/include")
  set(LIBMPG123_LIB_PATH "${LRYA_THIRD_PARTY_DIR}/mpg123/mac/lib")
...
foreach(LIB ${MPG123_LIBS})
  ...
  lrya_build_target_license(${LIB} "LGPL-2.1,${CMAKE_SOURCE_DIR}/licenses/mpg123.license")
endforeach()
