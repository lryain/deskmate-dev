...
conf = importlib.import_module('anki_vector.configure.__main__')
...
class DevSession():
    def __init__(self):
        self._url = 'https://session-certs-newdev.ddl.io'

    @property
    def name(self):
        return "DDL Newdev Cloud"
...
if __name__ == "__main__":
    ...
    conf.main(InternalApi('beta' if args[0].beta else 'dev'), DevSession())
