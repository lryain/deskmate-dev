...
#ifndef __AnkiAudio_PlugIns_AkAlsaSinkFactory_H__
#define __AnkiAudio_PlugIns_AkAlsaSinkFactory_H__
...
AK_STATIC_LINK_PLUGIN(AkAlsaSink)

#endif // __AnkiAudio_PlugIns_AkAlsaSinkFactory_H__
