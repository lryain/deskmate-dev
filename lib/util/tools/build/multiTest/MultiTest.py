...
parser.add_argument('--xml_basename', nargs='?', metavar='name',
                    default='basestationGoogleTest_',
                    help='base name for xml output. Files will be named like "name0.xml".Default is basestationGoogleTest_')
...
def runTestCase(testCase):
    ...
    try:
        ...
        fails.append("one of the following tests crashed:")
