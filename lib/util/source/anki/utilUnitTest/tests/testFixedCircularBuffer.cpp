/**
 * File: testFixedCircularBuffer
 *
 * Author: Lee Crippen
 * Created: 11/30/17
 *
 * Description: Unit tests for FixedCircularBuffer
 *
 * Copyright: Anki, Inc. 2017
 *
 * --gtest_filter=FixedCircularBuffer*
 **/
...
TEST(FixedCircularBuffer, LoopBufferPushBack)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
...
TEST(FixedCircularBuffer, LoopBufferPushBackArray)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
...
TEST(FixedCircularBuffer, LoopBufferNormVsArray)
{
  Anki::Util::FixedCircularBuffer<int, 100> testBufferNorm;
  Anki::Util::FixedCircularBuffer<int, 100> testBufferArray;
...
TEST(FixedCircularBuffer, LoopBufferFrontArray)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
...
TEST(FixedCircularBuffer, LoopBufferPushFront)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
...
TEST(FixedCircularBuffer, PushPopMix)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
...
TEST(FixedCircularBuffer, MoveConstructor)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
  ...
  Anki::Util::FixedCircularBuffer<int, 5> testBuff2( std::move(testBuff) ); // Move Constructor
...
TEST(FixedCircularBuffer, MoveAssignment)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
  ...
  Anki::Util::FixedCircularBuffer<int, 5> testBuff2;
...
TEST(FixedCircularBuffer, CopyConstructor)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
  ...
  Anki::Util::FixedCircularBuffer<int, 5> testBuff2( testBuff ); // CopyConstructor
...
TEST(FixedCircularBuffer, CopyAssignment)
{
  Anki::Util::FixedCircularBuffer<int, 5> testBuff;
